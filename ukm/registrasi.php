	...
	<div class="register">
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form action="action_daftar_ukm.php" method="post" enctype="multipart/form-data"><font color="black">
					...
					<input type="password" name="pass" placeholder="Masukan Password" required=" " ></br>
					<input type="file" name="fhoto" placeholder="Masukan Foto" id="fhoto" required>
