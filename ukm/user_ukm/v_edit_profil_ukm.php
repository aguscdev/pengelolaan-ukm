  ...
  <div class="wrapper">
    ...
    <div class="contents">
      ...
      include '../../config/koneksi.php';
			...
			$data = mysqli_query($koneksi,"select * from user_ukm where id_user_ukm='$id'");
			...
			<form method="post" action="action_edit_profil_ukm.php"> <!-- update.php -->
              ...
              <a class="btn btn-danger" href="../user_ukm/profil_user_ukm.php?id=<?php echo $_SESSION["id"]; ?>">Batal</a>
			</form>
			<?php 
			}
			?>
