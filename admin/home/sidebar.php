...
<aside class="main-sidebar">
        ...
        <li>
            ...
            <div id="ukm" class="collapse ">
                <ul class="nav">
                    ...
                    <li><a href="../admin_ukm/v_admin_ukm.php" class=""><i class="fa fa-user-o text-aqua"></i> &nbsp User UKM</a></li>
                </ul>
            </div>
        </li>
         <?php } ?>
    ...
    <?php if ($level == 'ADMIN'){ ?>
        <li>
            <a href="#order" data-toggle="collapse" class="collapsed"><i class="fa fa-folder text-aqua"></i> <span>ORDER</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
            <div id="order" class="collapse ">
                <ul class="nav">
                    <li><a href="../order/v_order.php" class=""><i class="fa fa-list"></i> &nbsp List Order</a></li>
    ...
    <?php if ($level == 'ADMIN'){ ?>
        <li class="">
            <a href="../user/v_user.php">
                <i class="fa fa-user-o text-aqua"></i><span>CUSTOMER</span>
                <span class="pull-right-container"></span>
            </a>
        </li>
    <?php } ?>
