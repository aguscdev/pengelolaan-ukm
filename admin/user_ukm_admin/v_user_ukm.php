      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="panel panel-default">
                ...
                <a class="btn btn-success" href="../user_ukm_admin/v_add_user_ukm.php"><i class="fa fa-pencil-square-o"></i>Tambah</a><br/><br/>
                    <table id="dtUser" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="v_edit_user_ukm.php?id=<?php echo $d['id']; ?>" class="btn btn-warning">Edit</a> ||
                                    <a href="action_delete_user_ukm.php?id=<?php echo $d['id']; ?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                            <?php
                                };
