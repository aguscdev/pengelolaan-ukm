    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="">
            <!-- <a href="../user_ukm/profil_user_ukm.php"> -->
                <a href="../user_ukm/profil_user_ukm.php?id=<?php echo $_SESSION["id"]; ?>">
            ...
            <div id="ukm" class="collapse ">
                <ul class="nav">
                    ...
                    <!-- <li><a href="../ukm/v_ukm.php" class=""><i class="fa fa-user-o text-aqua"></i> &nbsp List UKM</a></li> -->
                     <li class="nav">
                    <!-- <a href="../user_ukm/profil_user_ukm.php"> -->
                    <a href="../ukm/v_detail_ukm.php?id_ukm=<?php echo $_SESSION["id"]; ?>">
                    <i class="fa fa-list"></i><span>&nbsp Detail UKM</span>
                    <span class="pull-right-container"></span>
                    </a>
                    </li>
                </ul>
         ...
         <li>
            ...
            <div id="produk" class="collapse ">
                <ul class="nav">
                    ...
                    <li class="nav">
            <!-- <a href="../user_ukm/profil_user_ukm.php"> -->
                        <a href="../produk/v_detail_produk.php?id_produk=<?php echo $_SESSION["id"]; ?>">
                        <i class="fa fa-list"></i><span>&nbsp Detail Produk</span>
                        <span class="pull-right-container"></span>
                        </a>
                    </li>
                </ul>
