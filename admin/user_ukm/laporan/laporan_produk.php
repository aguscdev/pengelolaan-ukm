            ...
            <div class="panel panel-default">
              <div class="panel-heading">Laporan Produk</div>
                <div class="panel-body"><br/>
                    ...
                    <a class="btn btn-primary btn-lg" href="../laporan/cetak_produk.php?id_produk=<?php echo $_SESSION["id"]; ?>"><span class="glyphicon glyphicon-print"></span> Print</a>
                    <a class="btn btn-danger btn-lg" href="../laporan/pdf_produk.php?id_produk=<?php echo $_SESSION["id"]; ?>"><span class=""></span>Pdf</a>
                    <a class="btn btn-success btn-lg" href="../laporan/excel_produk.php?id_produk=<?php echo $_SESSION["id"]; ?>"><span class=""></span>Export</a>
				</div>
			</div>
        </section><br>
      </div>
