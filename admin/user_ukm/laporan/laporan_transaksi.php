            ...
            <div class="panel panel-default">
              <div class="panel-heading">Laporan Transaksi</div>
                <div class="panel-body"><br/>
                    ...
                    <a class="btn btn-primary btn-lg" href="../laporan/cetak_transaksi.php?id=<?php echo $_SESSION["id"]; ?>"><span class="glyphicon glyphicon-print"></span> Print</a>
                    <a class="btn btn-danger btn-lg" href="../laporan/pdf_transaksi.php?id=<?php echo $_SESSION["id"]; ?>"><span class=""></span>Pdf</a>
                    <a class="btn btn-success btn-lg" href="../laporan/excel_transaksi.php?id=<?php echo $_SESSION["id"]; ?>"><span class=""></span>Export</a>
				</div>
			</div>
        </section><br>
      </div>
